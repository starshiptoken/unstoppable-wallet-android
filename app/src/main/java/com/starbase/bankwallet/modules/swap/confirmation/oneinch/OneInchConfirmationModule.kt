package com.starbase.bankwallet.modules.swap.confirmation.oneinch
...
object OneInchConfirmationModule {
    ...
    class Factory(
        ...
        private val sendService by lazy { OneInchSendEvmTransactionService(evmKit, transactionService, com.starbase.bankwallet.core.App.activateCoinManager) }
