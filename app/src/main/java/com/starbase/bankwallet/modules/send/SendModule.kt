package com.starbase.bankwallet.modules.send
...
object SendModule {
    ...
    class Factory(private val wallet: Wallet) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val handler: ISendHandler = when (val adapter = com.starbase.bankwallet.core.App.adapterManager.getAdapterForWallet(wallet)) {
                is ISendBitcoinAdapter -> {
                    val bitcoinInteractor = SendBitcoinInteractor(adapter, com.starbase.bankwallet.core.App.localStorage)
    ...
    sealed class AmountInfo {
        ...
        fun getFormatted(): String = when (this) {
            ...
            is CurrencyValueInfo -> {
                com.starbase.bankwallet.core.App.numberFormatter.formatFiat(currencyValue.value, currencyValue.currency.symbol, 2, 2)
            }
        }

        fun getFormattedPlain(): String = when (this) {
            is CoinValueInfo -> {
                com.starbase.bankwallet.core.App.numberFormatter.format(value, 0, 8)
            }
            is CurrencyValueInfo -> {
                com.starbase.bankwallet.core.App.numberFormatter.formatFiat(currencyValue.value, currencyValue.currency.symbol, 2, 2)
            }
        ...
        fun getFormattedForTxInfo(): String = when (this) {
            ...
            is CurrencyValueInfo -> {
                val significantDecimal = com.starbase.bankwallet.core.App.numberFormatter.getSignificantDecimalFiat(currencyValue.value)

                com.starbase.bankwallet.core.App.numberFormatter.formatFiat(currencyValue.value, currencyValue.currency.symbol, 0, significantDecimal)
            }
        }
