...
object SwapMainModule {
    ...
    enum class Blockchain(val id: String, val title: String) : Parcelable {
        ...
        val evmKit: EthereumKit?
            get() = when (this) {
                Ethereum -> com.starbase.bankwallet.core.App.ethereumKitManager.evmKit
                BinanceSmartChain -> com.starbase.bankwallet.core.App.binanceSmartChainKitManager.evmKit
            }
        ...
        val coin: Coin?
            get() = when (this) {
                Ethereum -> com.starbase.bankwallet.core.App.coinKit.getCoin(CoinType.Ethereum)
                BinanceSmartChain -> com.starbase.bankwallet.core.App.coinKit.getCoin(CoinType.BinanceSmartChain)
            }
    }
        ...
        override fun <T : ViewModel?> create(
            ...
            return when (modelClass) {
                SwapCoinCardViewModel::class.java -> {
                    val fiatService =
                        FiatService(switchService, com.starbase.bankwallet.core.App.currencyManager, com.starbase.bankwallet.core.App.xRateManager)
                    ...
                    val formatter = SwapViewItemHelper(com.starbase.bankwallet.core.App.numberFormatter)
