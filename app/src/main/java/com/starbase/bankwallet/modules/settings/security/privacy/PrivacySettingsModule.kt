package com.starbase.bankwallet.modules.settings.security.privacy
...
object PrivacySettingsModule {
    ...
    fun init(view: PrivacySettingsViewModel, router: IPrivacySettingsRouter) {
        val interactor = PrivacySettingsInteractor(
                com.starbase.bankwallet.core.App.pinComponent,
                com.starbase.bankwallet.core.App.torKitManager,
                com.starbase.bankwallet.core.App.initialSyncModeSettingsManager,
