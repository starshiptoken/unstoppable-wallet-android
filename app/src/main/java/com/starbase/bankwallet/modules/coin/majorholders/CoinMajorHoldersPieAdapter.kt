package com.starbase.bankwallet.modules.coin.majorholders
...
class ViewHolderItem(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer {
    fun bind(holders: List<MajorHolderItem.Item>) {
        ...
        majorHolderPercent.text = com.starbase.bankwallet.core.App.numberFormatter.format(portionMajor, 0, 2, suffix = "%")
    }
}
