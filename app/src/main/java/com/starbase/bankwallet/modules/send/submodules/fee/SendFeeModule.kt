package com.starbase.bankwallet.modules.send.submodules.fee
...
object SendFeeModule {
    ...
    class Factory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val feeCoinData = com.starbase.bankwallet.core.App.feeCoinProvider.feeCoinData(coin)
            val feeCoin = feeCoinData?.first ?: coin

            val baseCurrency = com.starbase.bankwallet.core.App.currencyManager.baseCurrency
            val helper = SendFeePresenterHelper(com.starbase.bankwallet.core.App.numberFormatter, feeCoin, baseCurrency)
            val interactor = SendFeeInteractor(baseCurrency, com.starbase.bankwallet.core.App.xRateManager, feeRateProvider, feeCoin)
            ...
            val presenter = SendFeePresenter(view, interactor, helper, coin, baseCurrency, feeCoinData, customPriorityUnit, FeeRateAdjustmentHelper(
                com.starbase.bankwallet.core.App.appConfigProvider))
