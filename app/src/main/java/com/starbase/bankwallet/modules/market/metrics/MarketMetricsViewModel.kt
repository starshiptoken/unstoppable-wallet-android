...
class MarketMetricsViewModel(
    ...
    private fun syncMarketMetrics(dataState: DataState<MarketMetricsItem>) {
        ...
        if (dataState is DataState.Success) {
            ...
            val btcDominanceFormatted = com.starbase.bankwallet.core.App.numberFormatter.format(marketMetricsItem.btcDominance, 0, 2, suffix = "%")
    ...
    private fun formatFiatShortened(value: BigDecimal, symbol: String): String {
        val (shortenValue, suffix) = com.starbase.bankwallet.core.App.numberFormatter.shortenValue(value)
        return com.starbase.bankwallet.core.App.numberFormatter.formatFiat(shortenValue, symbol, 0, 2) + " $suffix"
    }
