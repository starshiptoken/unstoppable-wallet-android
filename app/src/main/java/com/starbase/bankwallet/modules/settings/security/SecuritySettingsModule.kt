package com.starbase.bankwallet.modules.settings.security
...
object SecuritySettingsModule {
    ...
    fun init(view: SecuritySettingsViewModel, router: ISecuritySettingsRouter) {
        val interactor = SecuritySettingsInteractor(com.starbase.bankwallet.core.App.systemInfoManager, com.starbase.bankwallet.core.App.pinComponent)
