package com.starbase.bankwallet.modules.backupconfirmkey
...
object BackupConfirmKeyModule {
    ...
    class Factory(private val account: Account) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            val service = BackupConfirmKeyService(account, com.starbase.bankwallet.core.App.accountManager, RandomProvider())
