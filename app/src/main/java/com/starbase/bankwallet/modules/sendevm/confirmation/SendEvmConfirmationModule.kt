package com.starbase.bankwallet.modules.sendevm.confirmation
    ...
    class Factory(
        ...
        private val feeCoin by lazy {
            when (evmKit.networkType) {
                ...
                NetworkType.EthRinkeby -> com.starbase.bankwallet.core.App.coinKit.getCoin(CoinType.Ethereum)!!
                NetworkType.BscMainNet -> com.starbase.bankwallet.core.App.coinKit.getCoin(CoinType.BinanceSmartChain)!!
            }
        }
        ...
        private val coinServiceFactory by lazy { EvmCoinServiceFactory(feeCoin, com.starbase.bankwallet.core.App.coinKit, com.starbase.bankwallet.core.App.currencyManager, com.starbase.bankwallet.core.App.xRateManager) }
