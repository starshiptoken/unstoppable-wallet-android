    ...
    companion object {
        ...
        private fun createKit(wallet: Wallet, syncMode: SyncMode?, testMode: Boolean): DashKit {
            ...
            if (accountType is AccountType.Mnemonic) {
                return DashKit(context = com.starbase.bankwallet.core.App.instance,
        ...
        fun clear(walletId: String, testMode: Boolean) {
            DashKit.clear(com.starbase.bankwallet.core.App.instance, getNetworkType(testMode), walletId)
        }
    }
}
