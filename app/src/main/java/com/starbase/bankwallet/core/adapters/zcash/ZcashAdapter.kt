package com.starbase.bankwallet.core.adapters.zcash
...
class ZcashAdapter(
    ...
    companion object {
        ...
        fun clear(accountId: String, testMode: Boolean) {
            ...
            Initializer.erase(com.starbase.bankwallet.core.App.instance, network, getValidAliasFromAccountId(accountId))
        }
    }
}
