...
class BitcoinCashAdapter(
    ...
    companion object {
        ...
        private fun createKit(wallet: Wallet, syncMode: SyncMode?, testMode: Boolean): BitcoinCashKit {
            ...
            return BitcoinCashKit(context = com.starbase.bankwallet.core.App.instance,
        ...
        fun clear(walletId: String, testMode: Boolean) {
            BitcoinCashKit.clear(com.starbase.bankwallet.core.App.instance, getNetworkType(testMode), walletId)
        }
