package com.starbase.bankwallet.ui.helpers
...
object TextHelper : IClipboardManager {
    ...
    override fun copyText(text: String) {
        copyTextToClipboard(com.starbase.bankwallet.core.App.instance, text)
    }
    ...
    fun getQrCodeBitmap(address: String, size: Float = 150F): Bitmap? {
        ...
        return try {
            val imageSize = LayoutHelper.dp(size, com.starbase.bankwallet.core.App.instance)
    ...
    private val clipboard: ClipboardManager?
        get() = com.starbase.bankwallet.core.App.instance.getSystemService(Context.CLIPBOARD_SERVICE) as? ClipboardManager
